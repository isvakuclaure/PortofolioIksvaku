                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="order-1 md:order-2">
                      ...
                      <p className="text-slate-300 text-sm mb-4 leading-relaxed">
                        Aplicación moderna para la gestión de ascensores.
                        Mantenimiento y control de ascensores con interfaz
                        intuitiva y tecnología de vanguardia. Conexiones a Apis
                        y un sistema GRPC Streaming.
                      </p>
